...
def main():
    ...
    from AlpacaTrading.strategies.cross_sectional_momentum import CrossSectionalMomentumStrategy
    ...
    strategies = create_strategies(args.position_size, args.max_position, len(args.tickers))
