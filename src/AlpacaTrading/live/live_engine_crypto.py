...
class LiveEngineConfig:
    ...
    Attributes:
        alpaca_config: Alpaca API configuration (supports stocks and crypto)
...
class LiveTradingEngine:
    ...
    Supports Stocks and Crypto via the unified AlpacaTrader.

    Workflow:
    1. Receives real-time market data from Alpaca WebSocket (Stock or Crypto)
    ...
    Example:
        ...
        # For crypto: alpaca_config.crypto = True
    ...
    def __init__(
        ...
        # Initialize Alpaca trader (Crypto-aware)
    ...
    def _wait_for_fill(self, order_id: str, order: Order, timeout: int = 10) -> None:
        ...
        logger.warning(f"   Timeout waiting for fill (status: {status})")
    ...
    def _print_status(self) -> None:
        ...
        logger.info(f"Status (Tick #{self.tick_count}):")
